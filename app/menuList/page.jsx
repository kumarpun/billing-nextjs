...
export default function Menu() {
  ...
  const filteredItems = search.trim()
    ? menuItems.filter(item => item.value.toLowerCase().includes(search.trim().toLowerCase()))
    : menuItems;
            ...
            <div className="flex items-center justify-between mt-4 px-2">
              ...
              <div className="flex gap-1">
                ...
                {(() => {
                  ...
                  for (let i = Math.max(4, currentPage - 1); i <= Math.min(totalPages - 2, currentPage + 1); i++) addPage(i);
