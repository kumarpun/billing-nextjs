        ...
        <div className="bg-blue-50 border border-blue-100 text-blue-800 px-4 py-3 rounded-lg shadow-lg flex items-start gap-3 max-w-xs animate-fade-in">
          <div className="flex-1">
            <div className="flex items-center gap-2">
              ...
              <strong className="block font-semibold text-sm">📝 Checklist Remaining</strong>
            </div>
            <p className="mt-1 ml-7 text-xs">Please complete the task before checking me</p>
            {/* <p className="mt-1 ml-7 text-sm">🛎️ Please clean me (Food Tray)</p> */}
          </div>
          <button
            onClick={handleClose}
