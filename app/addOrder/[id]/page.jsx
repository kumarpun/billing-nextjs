...
export default function AddOrder({ params }) {
    ...
    const options = [
     ...
     { value: 'Dynamite Fries - veg', label: 'Dynamite Fries veg - NRs 295', price: 295, order_type: "Kitchen" },
     { value: 'Veg Crispy', label: 'Veg Crispy - NRs 250', price: 250, order_type: "Kitchen" },
     { value: 'Paneer Chilly', label: 'Paneer Chilly - NRs 455', price: 455, order_type: "Kitchen" },
     { value: 'Corn salt & Pepper', label: 'Corn salt & Pepper - NRs 265', price: 265, order_type: "Kitchen" },
     { value: 'Aloo Papdi Chat', label: 'Aloo Papdi Chat - NRs 240', price: 240, order_type: "Kitchen" },
     { value: 'French Fries', label: 'French Fries - NRs 155', price: 155, order_type: "Kitchen" },
     ...
     { value: 'Afgani Fries', label: 'Afgani Fries - NRs 235', price: 235, order_type: "Kitchen" },
     ...
     { value: 'Mustang Aalo', label: 'Mustang Aalo  - NRs 335', price: 335, order_type: "Kitchen" },
     { value: 'Aalo Jeera', label: 'Aalo Jeera  - NRs 285', price: 285, order_type: "Kitchen" },
     { value: 'Peanut dry', label: 'Peanut dry  - NRs 145', price: 145, order_type: "Kitchen" },
     { value: 'Chips Chilly', label: 'Chips Chilly  - NRs 315', price: 315, order_type: "Kitchen" },

     // NEPALI CUISINE
     { value: 'Chicken Choila', label: 'Chicken Choila - NRs 365', price: 365, order_type: "Kitchen" },
     { value: 'Chicken Tass', label: 'Chicken Tass - NRs 400', price: 400, order_type: "kitchen" },
     { value: 'Chicken Sadheko Fry/Boill', label: 'Chicken Sadheko Fry/Boill - NRs 325', price: 325, order_type: "Kitchen" },
     { value: 'Chicken Roast', label: 'Chicken Roast - NRs 400', price: 400, order_type: "Kitchen" },
     { value: 'Peanut Sadheko', label: 'Peanut Sadheko - NRs 225', price: 225, order_type: "Kitchen" },
     { value: 'Wai Wai Sadheko', label: 'Wai Wai Sadheko - NRs 175', price: 175, order_type: "Kitchen" },
     ...
     { value: 'Chicken Chatpate', label: 'Chicken Chatpate - NRs 325', price: 325, order_type: "Kitchen" },
     { value: 'Sukuti Chatpate Buff', label: 'Sukuti Chatpate Buff - NRs 385', price: 385, order_type: "Kitchen" },
     { value: 'Chicken Timur', label: 'Chicken Timur - NRs 365', price: 365, order_type: "Kitchen" },
     { value: 'Prawn Chilly', label: 'Prawn Chilly  - NRs 695', price: 695, order_type: "Kitchen" },
     { value: 'Sweet corn Sadheko', label: 'Sweet corn Sadheko - NRs 255', price: 255, order_type: "Kitchen" },

     // NON-VEG STARTER
     { value: 'Dynamite Fries non veg', label: 'Dynamite Fries non veg - NRs 395', price: 395, order_type: "Kitchen" },
     { value: 'Chicken Chilly', label: 'Chicken Chilly - NRs 365', price: 365, order_type: "Kitchen" },
     { value: 'Hot Wings', label: 'Hot Wings - NRs 455', price: 455, order_type: "Kitchen" },
     ...
     { value: 'Dragon Chicken', label: 'Dragon Chicken - NRs 425', price: 425, order_type: "Kitchen" },
     ...
     { value: 'Sausage Chilly', label: 'Sausage Sausage - NRs 345', price: 345, order_type: "Kitchen" },
     { value: 'Crown Chicken', label: 'Crown Chicken - NRs 490', price: 490, order_type: "Kitchen" },
     { value: 'Boiled Sausage', label: 'Boiled Sausage - NRs 245', price: 245, order_type: "Kitchen" },
     ...
     { value: 'Sausage fry', label: 'Sausage fry - NRs 255', price: 255, order_type: "Kitchen" },
     { value: 'Drums of Heaven', label: 'Drums of Heaven - NRs 445', price: 445, order_type: "Kitchen" },
     { value: 'Chicken lollipop', label: 'Chicken lollipop - NRs 405', price: 405, order_type: "Kitchen" },

     { value: 'Fish finger', label: 'Fish finger - NRs 415', price: 415, order_type: "Kitchen" },
     { value: 'Spicy pork belly', label: 'Spicy pork belly - NRs 445', price: 445, order_type: "Kitchen" },

     { value: 'Veg momo platter', label: 'Veg momo platter - NRs 455', price: 455, order_type: "Kitchen" },
     { value: 'Chicken momo platter', label: 'Chicken momo platter - NRs 515', price: 515, order_type: "Kitchen" },
     { value: 'Buff momo platter', label: 'Buff momo platter - NRs 525', price: 525, order_type: "Kitchen" },

     { value: 'Combo Chicken', label: 'Combo Chicken - NRs 575', price: 575, order_type: "Kitchen" },

       // SALAD
       { value: 'Green Salad', label: 'Green Salad - NRs 225', price: 225, order_type: "Kitchen" },
       { value: 'Fruit Salad', label: 'Fruit Salad - NRs 425', price: 425, order_type: "Kitchen" },
       { value: 'Russian Salad', label: 'Russian Salad - NRs 295', price: 295, order_type: "Kitchen" },
       { value: 'Eggmayo Salad', label: 'Eggmayo Salad - NRs 350', price: 350, order_type: "Kitchen" },
       { value: 'Nepali Salad', label: 'Nepali Salad - NRs 195', price: 195, order_type: "Kitchen" },
       ...
       { value: 'Chicken Boiled', label: 'Chicken Boiled - NRs 325', price: 325, order_type: "Kitchen" },
       { value: 'Mix veg boiled', label: 'Mix veg boiled - NRs 355', price: 355, order_type: "Kitchen" },
       { value: 'Mix veg Saute', label: 'Mix veg Saute - NRs 385', price: 385, order_type: "Kitchen" },
       { value: 'Mix non veg boiled', label: 'Mix non veg boiled - NRs 395', price: 395, order_type: "Kitchen" },
       { value: 'Mix non veg Saute', label: 'Mix non veg Saute - NRs 425', price: 425, order_type: "Kitchen" },
       { value: 'Sweet corn boiled', label: 'Sweet corn boiled - NRs 155', price: 155, order_type: "Kitchen" },

       { value: 'Chessy crunchu chips', label: 'Chessy crunchu chips - NRs 150', price: 150, order_type: "Kitchen" },


       // SOUP
       { value: 'Manchow Soup (Veg)', label: 'Manchow Soup (Veg) - NRs 165', price: 165, order_type: "Kitchen" },
       { value: 'Manchow Soup (Non-Veg)', label: 'Manchow Soup (Non-Veg) - NRs 215', price: 215, order_type: "Kitchen" },
       { value: 'Hot & Sour Soup (Veg)', label: 'Hot & Sour Soup (Veg) - NRs 165', price: 165, order_type: "Kitchen" },
       { value: 'Hot & Sour Soup (Non-Veg)', label: 'Hot & Sour Soup (Non-Veg) - NRs 215', price: 215, order_type: "Kitchen" },
       { value: 'Clear Soup (Veg)', label: 'Clear Soup (Veg) - NRs 155', price: 155, order_type: "Kitchen" },
       { value: 'Clear Soup (Non-Veg)', label: 'Clear Soup (Non-Veg) - NRs 195', price: 195, order_type: "Kitchen" },
       ...
       { value: 'Mushroom Soup', label: 'Mushroom Soup - NRs 175', price: 175 },

       // INDIAN CUISINE
       { value: 'Chicken Curry', label: 'Chicken Curry - NRs 395', price: 395, order_type: "Kitchen" },
       { value: 'Chicken kadai', label: 'Chicken kadai - NRs 415', price: 415, order_type: "Kitchen" },
       { value: 'Butter Chicken', label: 'Butter Chicken - NRs 435', price: 435, order_type: "Kitchen" },

       { value: 'Plain rice', label: 'Plain rice - NRs 125', price: 125, order_type: "Kitchen" },
       { value: 'Jeera rice', label: 'Jeera rice - NRs 135', price: 135, order_type: "Kitchen" },
       { value: 'Tawa roti', label: 'Rawa roti - NRs 15', price: 15, order_type: "Kitchen" },
       { value: 'Butter roti', label: 'Butter roti - NRs 25', price: 25, order_type: "Kitchen" },

       // LAPHING
       { value: 'Plain Laphing', label: 'Plain Laphing - NRs 120', price: 120, order_type: "Kitchen" },
       { value: 'Chicken Laphing', label: 'Chicken Laphing - NRs 255', price: 255, order_type: "Kitchen" },
       { value: 'Soupy Chauchau Laphing', label: 'Soupy Chauchau Laphing - NRs 130', price: 130, order_type: "Kitchen" },
       { value: 'Waiwai Laphing', label: 'Waiwai Laphing - NRs 155', price: 155, order_type: "Kitchen" },
       { value: 'Soupy Peanuts Laphing', label: 'Soupy Peanuts Laphing - NRs 215', price: 215, order_type: "Kitchen" },
       { value: 'Peanuts Laphing', label: 'Peanuts Laphing - NRs 175', price: 175, order_type: "Kitchen" },

       { value: 'Sizzler veg', label: 'Sizzler veg - NRs 560', price: 560, order_type: "Kitchen" },
       { value: 'Chicken Sizzler', label: 'Chicken Sizzler - NRs 495', price: 495, order_type: "Kitchen" },
       { value: 'Hybe special', label: 'Hybe special - NRs 1200', price: 1200, order_type: "Kitchen" },
       { value: 'Chinese Platter', label: 'Chinese Platter - NRs 1255', price: 1255, order_type: "Kitchen" },
       ...
       // MO:MO
       { value: 'Steam Veg momo', label: 'Steam Veg momo - NRs 145', price: 145, order_type: "Kitchen" },
       { value: 'Steam Chicken momo', label: 'Steam Chicken momo - NRs 195', price: 195, order_type: "Kitchen"},
       { value: 'Steam Buff momo', label: 'Steam Buff momo - NRs 215', price: 215, order_type: "Kitchen" },
    ...
    //    { value: 'Steam Buff MO:MO', label: 'Steam Buff MO:MO - NRs 220', price: 220 },
       { value: 'Chilly Veg MO:MO', label: 'Chilly Veg MO:MO - NRs 215', price: 215, order_type: "Kitchen" },
       { value: 'Chilly Chicken MO:MO', label: 'Chilly Chicken MO:MO - NRs 275', price: 275, order_type: "Kitchen" },
       { value: 'Chilly Buff MO:MO', label: 'Chilly Buff MO:MO - NRs 285', price: 285 , order_type: "Kitchen"},

       { value: 'Afghani Veg MO:MO', label: 'Afghani Veg MO:MO - NRs 245', price: 245, order_type: "Kitchen" },
       { value: 'Afghani Chicken MO:MO', label: 'Afghani Chicken MO:MO - NRs 345', price: 345, order_type: "Kitchen" },
       { value: 'Afghani Buff MO:MO', label: 'Afghani Buff MO:MO - NRs 365', price: 365, order_type: "Kitchen" },

       { value: 'Crunchy Veg MO:MO', label: 'Crunchy Veg MO:MO - NRs 235', price: 235, order_type: "Kitchen" },
       { value: 'Crunchy Chicken MO:MO', label: 'Crunchy Chicken MO:MO - NRs 295', price: 295, order_type: "Kitchen" },
       { value: 'Crunchy Buff MO:MO', label: 'Crunchy Buff MO:MO - NRs 315', price: 315, order_type: "Kitchen" },

       { value: 'Fried Veg MO:MO', label: 'Fried Veg MO:MO - NRs 185', price: 185, order_type: "Kitchen" },
       { value: 'Fried Chicken MO:MO', label: 'Fried Chicken MO:MO - NRs 245', price: 245, order_type: "Kitchen" },
       { value: 'Fried Buff MO:MO', label: 'Fried Buff MO:MO - NRs 255', price: 255, order_type: "Kitchen" },

       { value: 'Jhol Veg MO:MO', label: 'Jhol Veg MO:MO - NRs 215', price: 215, order_type: "Kitchen" },
       { value: 'Jhol Chicken MO:MO', label: 'Jhol Chicken MO:MO - NRs 265', price: 265, order_type: "Kitchen" },
       { value: 'Jhol Buff MO:MO', label: 'Jhol Buff MO:MO - NRs 285', price: 285, order_type: "Kitchen" },

       { value: 'Kothe Veg MO:MO', label: 'Kothe Veg MO:MO - NRs 185', price: 185, order_type: "Kitchen"},     
       { value: 'Kothe Chicken MO:MO', label: 'Kothe Chicken MO:MO - NRs 245', price: 245, order_type: "Kitchen"},
       { value: 'Kothe Buff MO:MO', label: 'Kothe Buff MO:MO - NRs 275', price: 275, order_type: "Kitchen"},

       { value: 'Sadheko Veg MO:MO', label: 'Sadheko Veg MO:MO - NRs 215', price: 215, order_type: "Kitchen"},
       { value: 'Sadheko Chicken MO:MO', label: 'Sadheko Chicken MO:MO - NRs 285', price: 285, order_type: "Kitchen" },
       { value: 'Sadheko Buff MO:MO', label: 'Sadheko Buff MO:MO - NRs 295', price: 295, order_type: "Kitchen" },
     
       // PASTA
       { value: 'Veg Pasta (White)', label: 'Veg Pasta (White) - NRs 315', price: 315, order_type: "Kitchen" },
       { value: 'Veg Pasta (Red)', label: 'Veg Pasta (Red) - NRs 315', price: 315, order_type: "Kitchen"},
       { value: 'Veg Pasta (Mixed)', label: 'Veg Pasta (Mixed) - NRs 315', price: 315, order_type: "Kitchen" },

       { value: 'Non-Veg Pasta (White)', label: 'Non-Veg Pasta (White) - NRs 395', price: 395, order_type: "Kitchen" },
       { value: 'Non-Veg Pasta (Red)', label: 'Non-Veg Pasta (Red) - NRs 395', price: 395, order_type: "Kitchen" },
       { value: 'Non-Veg Pasta (Mixed)', label: 'Non-Veg Pasta (Mixed) - NRs 395', price: 395 , order_type: "Kitchen"},

       { value: 'Aglio e Olio Veg', label: 'Aglio e Olio Veg - NRs 345', price: 345, order_type: "Kitchen" },
       { value: 'Aglio e Olio Non-Veg', label: 'Aglio e Olio Non-Veg - NRs 385', price: 385, order_type: "Kitchen" },
       ...
       // PIZZA
       { value: 'Margherita Pizza', label: 'Margherita Pizza - NRs 485', price: 485, order_type: "Kitchen" },
       { value: 'Farm House Pizza', label: 'Farm House Pizza - NRs 450', price: 450, order_type: "Kitchen" },
       { value: 'Chicken Pizza', label: 'Chicken Pizza - NRs 525', price: 525, order_type: "Kitchen" },
       { value: 'Chicken Mix Pizza', label: 'Chicken Mix Pizza - NRs 555', price: 555, order_type: "Kitchen" },
       { value: 'Pizza Ala Fungi', label: 'Pizza Ala Fungi - NRs 505', price: 505, order_type: "Kitchen" },
       ...
       { value: 'Veg Biryani', label: 'Veg Biryani - NRs 435', price: 435, order_type: "Kitchen" },
       { value: 'Non-Veg Biryani', label: 'Non-Veg Biryani - NRs 535', price: 535 , order_type: "Kitchen"},
     
       // NOODLES
       { value: 'Keema Noodles', label: 'Keema Noodles - NRs 395', price: 395, order_type: "Kitchen" },

       { value: 'Hakka Noodles (Veg)', label: 'Hakka Noodles (Veg) - NRs 185', price: 185, order_type: "Kitchen" },
       { value: 'Hakka Noodles (Chicken)', label: 'Hakka Noodles (Chicken) - NRs 225', price: 225, order_type: "Kitchen" },
       { value: 'Hakka Noodles (Buff)', label: 'Hakka Noodles (Buff) - NRs 245', price: 245, order_type: "Kitchen" },
       ...
       { value: 'Mixed Noodles', label: 'Mixed Noodles - NRs 345', price: 345, order_type: "Kitchen" },

       { value: 'Thukpa (Veg)', label: 'Thukpa (Veg) - NRs 215', price: 215, order_type: "Kitchen" },
       { value: 'Thukpa (Chicken)', label: 'Thukpa (Chicken) - NRs 295', price: 295, order_type: "Kitchen" },
       { value: 'Thukpa (Buff)', label: 'Thukpa (Buff) - NRs 315', price: 315, order_type: "Kitchen" },

       { value: 'Current noodles with sunny side', label: 'Current noodles with sunny side - NRs 245', price: 245, order_type: "Kitchen" },
       ...
       { value: 'Jackson chicken', label: 'Jackson chicken - NRs 595', price: 595, order_type: "Kitchen" },
       { value: 'Stuffed mushroom', label: 'Stuffed mushroom - NRs 485', price: 485, order_type: "Kitchen" },
       { value: 'Mutton taas', label: 'Mutton taas - NRs 465', price: 465, order_type: "Kitchen" },
       { value: 'Grilled chicken breast', label: 'Grilled chicken breast - NRs 445', price: 445, order_type: "Kitchen" },
       { value: 'Pahadi chicken', label: 'Pahadi chicken - NRs 395', price: 395, order_type: "Kitchen" },
       { value: 'Poleko wings', label: 'Poleko wings - NRs 445', price: 445, order_type: "Kitchen" },
       { value: 'Spicy leg', label: 'Spicy leg - NRs 445', price: 445, order_type: "Kitchen" },
       { value: 'Pork dameko', label: 'Pork dameko - NRs 495', price: 495, order_type: "Kitchen" },
